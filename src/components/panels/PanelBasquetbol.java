...
public class PanelBasquetbol extends JPanel {
    public PanelBasquetbol(Runnable onBack) {
        setLayout(null);
        setPreferredSize(new Dimension(1420, 1080));
        setBackground(Color.decode("#F5F5F5"));

        JLabel titulo = new JLabel("BÁSQUETBALL");
        titulo.setBounds(0, 0, 1420, 80);
        titulo.setOpaque(true);
        titulo.setBackground(Color.decode("#FF5722")); // Naranja
        ...
        btnVolver.setBackground(Color.decode("#FF5722"));
        btnVolver.setForeground(Color.WHITE);
        btnVolver.addActionListener(e -> onBack.run());
        add(btnVolver);

        JTextArea contenido = new JTextArea("Bienvenido a la sección de básquetball.\nAquí podrás ver noticias, partidos y publicaciones relacionadas.");
